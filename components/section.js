  ...
  return (
    <section>
      ...
      {sectionData.jobs ? (
        <>
          <h3>Work</h3>
          <h4>{sectionData.jobs.company} - {sectionData.jobs.title}</h4>
          <span>
      ...
      {sectionData.education ? (
        <>
          <h3>Education</h3>
          <h4>{sectionData.education.school} - {sectionData.education.title}</h4>
          <span>
            {sectionData.education.startDate} -{" "}
            {sectionData.education.endDate ? sectionData.education.endDate : "current"}
          </span>
        </>
      ) : null}
    </section>
